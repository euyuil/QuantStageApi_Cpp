...
conan create . QuantStageApi/20190107@liuyuesoft/stable -s compiler.version=5
...
# conan export-pkg . QuantStageApi/20190107@liuyuesoft/stable -s compiler.version=5 -f
